%Equation
function duhatdt = rhspde_CW(z, uhat, bf1,bf2, kappa, bs1, gamma, C, N, delta, count)
...
duhatdt2 = (-1i*bs1*delta.*fu2.*1) + (1i*gamma/2 *exp(1i*z.*kappa).*fft(u1.^2)) + (1i*fu2.*kappa) + (1i*fu3.*C);
