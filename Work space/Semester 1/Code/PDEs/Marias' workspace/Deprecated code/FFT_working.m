...
options = odeset('RelTol', 1e-18, 'AbsTol', 1e-20);


%% Fourier Frequency domain
z = [0:20/(N-1):20]'; % Spacial domain
[z, uhat] = ode45(@(z, uhat) rhspde_working(z,uhat, Beta_f1,Beta_f2, kappa, Beta_s1, gamma, C, N, delta), z, u0, options);
...
%Warning: Failure at t=1.140003e-03.  Unable to meet integration tolerances without reducing the step size below the smallest value allowed (3.469447e-18) at time t. 