...
I1 = 2; %Number of C varialbes being tested
I2 = 3; %Number of pw variables being tested
I3 = 3; %Number of A values being tested
I4 = 3; %Number of lambda variables being tested 
...
lambda = linspace(730, 760, I4)*10^-9;  %Range of lambda values to test
...
disp('The highest purity is p = ', num2str(maxPur), ' with the constants C = ', num2str(C(CIndex)), ' 1/cm, pulsewidth = ', num2str(pw(PWIndex)), 'ps, A = ', num2str(A(AIndex)), ' and lambda = ', num2str(lambda(LIndex)), 'nm')
